...
export default function Home() {
 ...
 <img src="/logo.png" alt="Zodiac Enterprise Logo - Premium Construction Materials Supplier in GCC Countries" className="w-40 h-12 mr-3" />
 ...
 <div>
 <img src="/hero-banner.jpg" alt="Premium Construction Materials in GCC Countries - Wall Putty, Drywall Panels, Cement Blocks, Precast Concrete, Solar Glass" className="w-full h-[80vh] object-cover rounded-2xl shadow-lg" />
 </div>
 </div>
 </section>
 ...
 <img src="/products/drywall-putty.png" alt="High-Quality Drywall Panels for GCC Construction Projects" className="object-cover w-full h-full" />
 </div>
 </div>
 )}
 ...
 <div className="h-96 flex items-center justify-center overflow-hidden rounded-xl shadow-lg">
 <img src={solarBlockImages[solarIndex]} alt="Solar Panel Cement Blocks for GCC Solar Projects and Renewable Energy Installations" className="object-cover w-full h-full transition-all duration-700" />
 </div>
 </div>
 )}
 ...
 <div className="h-96 flex items-center justify-center overflow-hidden rounded-xl shadow-lg">
 <img src={glassImages[glassIndex]} alt="Premium Glass Panels for Solar Installations in GCC Countries" className="object-cover w-full h-full transition-all duration-700" />
 </div>
 </div>
 )}
 ...
 <div className="h-96 flex items-center justify-center overflow-hidden rounded-xl shadow-lg">
 <img src="/products/precast-concrete.jpg" alt="Precast Concrete Panels for Construction Projects in GCC Countries" className="object-cover w-full h-full" />
 </div>
 </div>
 )}
 </div>
