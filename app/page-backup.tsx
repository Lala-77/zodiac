...
export default function Home() {
  ...
  const glassImages = [
    ...
    "/products/glass5.webp",
    "/products/glass6.webp",
    "/products/glass7.webp",
    "/products/glass8.webp",
    "/products/glass9.webp",
    "/products/glass10.webp",
  ];
  ...
  const solarBlockImages = [
    ...
    "/products/solar-blocks4.webp",
    "/products/solar-blocks5.webp",
  ];
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:image" content="https://www.zodiacenterprise.com/og-image.webp" />
        ...
        <meta
          ...
          content="Supplier of premium construction materials including wall putty, drywall panels, cement blocks, precast concrete and glass panels for solar installations across GCC countries."
        />
        <meta property="twitter:image" content="https://www.zodiacenterprise.com/twitter-image.webp" />
